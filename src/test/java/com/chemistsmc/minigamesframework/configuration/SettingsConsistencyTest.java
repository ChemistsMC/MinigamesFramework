...
import static com.chemistsmc.minigamesframework.TestHelper.getJarFile;
import static org.hamcrest.Matchers.empty;
import static org.hamcrest.core.IsEqual.equalTo;
import static org.junit.Assert.assertThat;

/**
 * Tests that the config.yml file corresponds with
 * the settings holder classes in the code.
 */
public class SettingsConsistencyTest
{
    ...
    private final ConfigurationData configData = ConfigurationDataBuilder.collectData(FrameworkSettings.class);
    ...
    public void shouldNotHaveUnknownProperties() {
        ...
        // when / then
        assertThat("config.yml has unknown properties", Sets.difference(keysInYml, keysInCode), empty());
    }
}
